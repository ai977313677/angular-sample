...
@Component({
  selector: 'app-ckplayer-demo',
  templateUrl: './ckplayer-demo.component.html',
  styleUrls: ['./ckplayer-demo.component.css']
})
export class CkplayerDemoComponent implements OnInit {
  title = 'ckplayerDemo';
  ...
  showCKPlayer() {
    ...
    this.timer = setInterval(() => {
      ...
      if (document.getElementById('video') != null) {
        ...
        this.msgService.info('div动态创建用时' + (loadFinish.getTime() - loadBegin.getTime()));
        this.player = new ckplayer(videoObject);
      }
    }, 1);
  }
